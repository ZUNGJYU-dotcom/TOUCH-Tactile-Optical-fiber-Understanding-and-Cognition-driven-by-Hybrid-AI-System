...
version_payload = json.loads(beta_version.read_text(encoding="utf-8"))
...
# The one-file release extracts these resources to PyInstaller's private
# runtime directory. The launcher resolves that directory through sys._MEIPASS.
datas = [
...
# Passing binaries and datas directly to EXE produces one distributable file;
# no COLLECT stage or neighboring _internal directory is required.
exe = EXE(
    pyz,
    a.scripts,
    a.binaries,
    a.datas,
    [],
    name=f"TOUCH-Beta-v{numeric_version}",
